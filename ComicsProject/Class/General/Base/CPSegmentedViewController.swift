//
//  CPSegmentedViewController.swift
//  ComicsProject
//
...
class CPSegmentedViewController: CPBaseViewController{
    
    

    var pageStyle : CPPageStyle!
    ...
    convenience init(titles: [String] = [], vcs: [UIViewController] = [], pageStyle: CPPageStyle = .none){
        self.init()
        self.titles = titles
        self.vcs    = vcs
...
extension CPSegmentedViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
